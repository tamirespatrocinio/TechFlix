        ...
        <div class="container">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th scope="row"><?= $dados["nomefil"] ?></th>
                            <td><img src="<?= $dados["capafil"] ?>" width="100"> </td>
                            <td><?= $dados["sinopsefil"] ?></td>
                            <td><iframe src="<?= $dados["urlfil"] ?>" width="200px" frameborder="0"></iframe></td>
                        </tr>
                    <?php
                    endforeach
                    ?>
