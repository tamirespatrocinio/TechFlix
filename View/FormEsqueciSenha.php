    ...
    <div class="banner">
        ...
        <div class="container">
            <div class="content">
                ...
                <h1 class="text-center text-white"> Esqueceu a senha? </h1>
                <h3 class="text-center text-white">Preencha corretamente as informações abaixo</h3>
                ...
                <form id="formEsqueceuSenha" action="../Controller/trocarSenha.php" method="post" class="formUsuario g-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="password" class="form-control" name="novasenha" id="inputSenha" />
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="col-auto">
                            <a href="AcessoFuncionario.php"><button class="btn">Voltar</button></a>
                        </div>
                    </div>
                </form>
            </div>
